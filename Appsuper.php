    ...
    <body>
        <header>
            <div class="contenedor">
                ...
                <a class="logo" href="Appsuper.php">
                ...
                <nav>
                    <ul class="menu">
                        ...
                        <li><a href="cuenta.php" target="_blank">Crear Cuenta</a></li>
...
<!--Mostrar Datos-->
        ...
        <form id="cont-buscar" name="bar-buscar" method='post' action="controlApp.php"> 
            <input type="search" name="buscador" id="txt-buscar" onchange="document.links.enlace.href='AppRsuper.php?id='+this.value" placeholder="Ingrese el número de trámite para buscar" autofocus required>
            
            <a type="submit" name="enlace" id="btn-buscar" href="AppRsuper.php?id">Buscar</a>
        </form>
